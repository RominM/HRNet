...
! function () {
   ...
   D = function (e, t) {
      ...
      parseDate: function (e, t) {
         ...
         for (n = e.replace(c.separators, "�").split("�"), r = 0; r < n.length; r++) switch (o = n[r], i = parseInt(o), a[r]) {
            case "y":
            case "Y":
               if (!i) return null;
      ...
      guessDate: function (e, t) {
         ...
         var a, n, r, o, i, s, d = e.replace(this.separators, "�").split("�"),
   ...
   L.extend(L.datetimepicker, t), r(), window.getComputedStyle || (window.getComputedStyle = function (a) {
      ...
      return this.each(function () {
         var o, i, s, d, u, l = L(this),
            ...
            h = 0,
            g = function () {};
         "hide" !== D ? (L(this).classList.contains("xdsoft_scroller_box") || (o = l.children().eq(0), i = l[0].clientHeight, s = o[0].offsetHeight, d = L('<div class="xdsoft_scrollbar"></div>'), u = L('<div class="xdsoft_scroller"></div>'), d.insertAdjacentHTML("beforeend",u), l.classList.add("xdsoft_scroller_box").insertAdjacentHTML("beforeend",d), g = function (e) {
            var t = a(e).y - r + h;
            t < 0 && (t = 0), t + u[0].offsetHeight > m && (t = m - u[0].offsetHeight), l.trigger("scroll_element.xdsoft_scroller", [f ? t / f : 0])
         }, u.addEventListener("touchstart.xdsoft_scroller mousedown.xdsoft_scroller", function (e) {
            i || l.trigger("resize_scroll.xdsoft_scroller", [D]), r = a(e).y, h = parseInt(u.css("margin-top"), 10), m = d[0].offsetHeight, "mousedown" === e.type || "touchstart" === e.type ? (p.ownerDocument && L(p.ownerDocument.body).classList.add("xdsoft_noselect"), L([p.ownerDocument.body, p.contentWindow]).addEventListener("touchend mouseup.xdsoft_scroller", function e() {
               L([p.ownerDocument.body, p.contentWindow]).removeEventListener("touchend mouseup.xdsoft_scroller", e).removeEventListener("mousemove.xdsoft_scroller", g).removeClass("xdsoft_noselect")
            }), L(p.ownerDocument.body).addEventListener("mousemove.xdsoft_scroller", g)) : (t = !0, e.stopPropagation(), e.preventDefault())
         }).addEventListener("touchmove", function (e) {
            t && (e.preventDefault(), g(e))
         }).addEventListener("touchend touchcancel", function () {
            t = !1, h = 0
         }), l.addEventListener("scroll_element.xdsoft_scroller", function (e, t) {
         ...
         }).addEventListener("resize_scroll.xdsoft_scroller", function (e, t, a) {
            var n, r;
         ...
         }), l.addEventListener("touchend touchcancel", function () {
            n = !1, c = 0
         })), l.trigger("resize_scroll.xdsoft_scroller", [D])) : l.querySelector(".xdsoft_scrollbar").hide()
      })
      ...
      return n = function (O) {
         var t, n, a, r, W, h, _ = L('<div class="xdsoft_datetimepicker xdsoft_noselect"></div>'),
            ...
            u = o.querySelector(".xdsoft_time_box").eq(0),
            ...
            s = !1,
            d = 0;
         N.id && _.attr("id", N.id), N.style && _.attr("style", N.style), N.weeks && _.classList.add("xdsoft_showweeks"), N.rtl && _.classList.add("xdsoft_rtl"), _.classList.add("xdsoft_" + N.theme), _.classList.add(N.className), F.querySelector(".xdsoft_month span").after(Y), F.querySelector(".xdsoft_year span").after(A), F.querySelector(".xdsoft_month,.xdsoft_year").addEventListener("touchstart mousedown.xdsoft", function (e) {
            var t, a, n = L(this).querySelector(".xdsoft_select").eq(0),
               r = 0,
               o = 0,
               i = n.is(":visible");
            for (F.querySelector(".xdsoft_select").hide(), W.currentTime && (r = W.currentTime[L(this).classList.contains("xdsoft_month") ? "getMonth" : "getFullYear"]()), n[i ? "hide" : "show"](), t = n.querySelector("div.xdsoft_option"), a = 0; a < t.length && t.eq(a).data("value") !== r; a += 1) o += t[0].offsetHeight;
         ...
         function f() {
            var e, t = !1;
            return N.startDate ? t = W.strToDate(N.startDate) : (t = N.value || (O && O.val && O.value ? O.value : "")) ? (t = W.strToDateTime(t), N.yearOffset && (t = new Date(t.getFullYear() - N.yearOffset, t.getMonth(), t.getDate(), t.getHours(), t.getMinutes(), t.getSeconds(), t.getMilliseconds()))) : N.defaultDate && (t = W.strToDateTime(N.defaultDate), N.defaultTime && (e = W.strtotime(N.defaultTime), t.setHours(e.getHours()), t.setMinutes(e.getMinutes()))), t && W.isValidDate(t) ? _.data("changed", !0) : t = "", t || 0
         }

         function c(m) {
            var h = function (e, t) {
               // .replace(/([[]/{}()-.+]{1})/g, "\$1").
                  var a = e.replace(/_/g, "{digit+}").replace(/([0-9]{1})/g, "{digit$1}").replace(/{digit([0-9]{1})}/g, "[0-$1_]{1}").replace(/{digit[+]}/g, "[0-9_]{1}");
            ...
            m.mask && O.removeEventListener("keydown.xdsoft"), !0 === m.mask && (E.formatMask ? m.mask = E.formatMask(m.format) : m.mask = m.format.replace(/Y/g, "9999").replace(/F/g, "9999").replace(/m/g, "19").replace(/d/g, "39").replace(/H/g, "29").replace(/i/g, "59").replace(/s/g, "59")), "string" === L.type(m.mask) && (h(m.mask, O.value) || (O.val(m.mask.replace(/[0-9]/g, "_")), g(O[0], 0)), O.addEventListener("paste.xdsoft", function (e) {
            ...
            }), O.addEventListener("keydown.xdsoft", function (e) {
               var t, a = this.value,
                  n = e.which,
         ...
         F.querySelector(".xdsoft_select").xdsoftScroller(N).addEventListener("touchstart mousedown.xdsoft", function (e) {
            var t = e.originalEvent;
            this.touchMoved = !1, this.touchStartPosition = t.touches ? t.touches[0] : t, e.stopPropagation(), e.preventDefault()
         }).addEventListener("touchmove", ".xdsoft_option", l).addEventListener("touchend mousedown.xdsoft", ".xdsoft_option", function () {
            if (!this.touchMoved) {
               void 0 !== W.currentTime && null !== W.currentTime || (W.currentTime = W.now());
               var e = W.currentTime.getFullYear();
               W && W.currentTime && W.currentTime[L(this).parent().parent().classList.contains("xdsoft_monthselect") ? "setMonth" : "setFullYear"](L(this).data("value")), L(this).parent().parent().hide(), _.trigger("xchange.xdsoft"), N.onChangeMonth && L.isFunction(N.onChangeMonth) && N.onChangeMonth.call(_, W.currentTime, _.data("input")), e !== W.currentTime.getFullYear() && L.isFunction(N.onChangeYear) && N.onChangeYear.call(_, W.currentTime, _.data("input"))
            }
         }), _.getValue = function () {
            ...
            N = L.extend(!0, {}, N, e), e.allowTimes && L.isArray(e.allowTimes) && e.allowTimes.length && (N.allowTimes = L.extend(!0, [], e.allowTimes)), e.weekends && L.isArray(e.weekends) && e.weekends.length && (N.weekends = L.extend(!0, [], e.weekends)), e.allowDates && L.isArray(e.allowDates) && e.allowDates.length && (N.allowDates = L.extend(!0, [], e.allowDates)), e.allowDateRe && "[object String]" === Object.prototype.toString.call(e.allowDateRe) && (N.allowDateRe = new RegExp(e.allowDateRe)), e.highlightedDates && L.isArray(e.highlightedDates) && e.highlightedDates.length && (L.each(e.highlightedDates, function (e, t) {
               ...
               void 0 !== l[o] ? (a = l[o].desc) && a.length && r.desc && r.desc.length && (l[o].desc = a + "n" + r.desc) : l[o] = r
               ...
               for (; a <= n;) o = new m(a, r, d), i = E.formatDate(a, N.formatDate), a.setDate(a.getDate() + 1), void 0 !== l[i] ? (s = l[i].desc) && s.length && o.desc && o.desc.length && (l[i].desc = s + "n" + o.desc) : l[i] = o
            }), N.highlightedDates = L.extend(!0, [], l)), e.disabledDates && L.isArray(e.disabledDates) && e.disabledDates.length && (N.disabledDates = L.extend(!0, [], e.disabledDates)), e.disabledWeekDays && L.isArray(e.disabledWeekDays) && e.disabledWeekDays.length && (N.disabledWeekDays = L.extend(!0, [], e.disabledWeekDays)), !N.open && !N.opened || N.inline || O.trigger("open.xdsoft"), N.inline && (s = !0, _.classList.add("xdsoft_inline"), O.after(_).hide()), N.inverseButton && (N.next = "xdsoft_prev", N.prev = "xdsoft_next"), N.datepicker ? g.classList.add("active") : g.removeClass("active"), N.timepicker ? o.classList.add("active") : o.removeClass("active"), N.value && (W.setCurrentTime(N.value), O && O.val && O.val(W.str)), isNaN(N.dayOfWeekStart) ? N.dayOfWeekStart = 0 : N.dayOfWeekStart = parseInt(N.dayOfWeekStart, 10) % 7, N.timepickerScrollbar || u.xdsoftScroller(N, "hide"), N.minDate && /^[+-](.*)$/.test(N.minDate) && (N.minDate = E.formatDate(W.strToDateTime(N.minDate), N.formatDate)), N.maxDate && /^[+-](.*)$/.test(N.maxDate) && (N.maxDate = E.formatDate(W.strToDateTime(N.maxDate), N.formatDate)), N.minDateTime && /^+(.*)$/.test(N.minDateTime) && (N.minDateTime = W.strToDateTime(N.minDateTime).dateFormat(N.formatDate)), N.maxDateTime && /^+(.*)$/.test(N.maxDateTime) && (N.maxDateTime = W.strToDateTime(N.maxDateTime).dateFormat(N.formatDate)), i.toggle(N.showApplyButton), F.querySelector(".xdsoft_today_button").css("visibility", N.todayButton ? "visible" : "hidden"), F.querySelector("." + N.prev).css("visibility", N.prevButton ? "visible" : "hidden"), F.querySelector("." + N.next).css("visibility", N.nextButton ? "visible" : "hidden"), c(N), N.validateOnBlur && O.removeEventListener("blur.xdsoft").addEventListener("blur.xdsoft", function () {
               if (N.allowBlank && (!L.trim(L(this).value).length || "string" == typeof N.mask && L.trim(L(this).value) === N.mask.replace(/[0-9]/g, "_"))) L(this).val(null), _.data("xdsoft_datetime").empty();
               else {
                  var e = E.parseDate(L(this).value, N.format);
                  if (e) L(this).val(E.formatDate(e, N.format));
                  else {
                     var t = +[L(this).value[0], L(this).value[1]].join(""),
                        a = +[L(this).value[2], L(this).value[3]].join("");
                     !N.datepicker && N.timepicker && 0 <= t && t < 24 && 0 <= a && a < 60 ? L(this).val([t, a].map(function (e) {
                        return 9 < e ? e : "0" + e
                     }).join(":")) : L(this).val(E.formatDate(W.now(), N.format))
                  }
                  _.data("xdsoft_datetime").setCurrentTime(L(this).value)
               }
         ...
         }, _.data("options", N).addEventListener("touchstart mousedown.xdsoft", function (e) {
            return e.stopPropagation(), e.preventDefault(), A.hide(), Y.hide(), !1
         }), u.insertAdjacentHTML("beforeend",P), u.xdsoftScroller(N), _.addEventListener("afterOpen.xdsoft", function () {
            u.xdsoftScroller(N)
         }), _.insertAdjacentHTML("beforeend",g).insertAdjacentHTML("beforeend",o), !0 !== N.withoutCopyright && _.insertAdjacentHTML("beforeend",e), g.insertAdjacentHTML("beforeend",F).insertAdjacentHTML("beforeend",C).insertAdjacentHTML("beforeend",i), N.insideParent ? L(O).parent().insertAdjacentHTML("beforeend",_) : L(N.parentID).insertAdjacentHTML("beforeend",_), W = new function () {
            var r = this;
            r.now = function (e) {
               var t, a, n = new Date;
         ...
         }, i.addEventListener("touchend click", function (e) {
            e.preventDefault(), _.data("changed", !0), W.setCurrentTime(f()), O.val(W.str()), _.trigger("close.xdsoft")
         }), F.querySelector(".xdsoft_today_button").addEventListener("touchend mousedown.xdsoft", function () {
            _.data("changed", !0), W.setCurrentTime(0, !0), _.trigger("afterOpen.xdsoft")
         }).addEventListener("dblclick.xdsoft", function () {
         ...
         }), F.querySelector(".xdsoft_prev,.xdsoft_next").addEventListener("touchend mousedown.xdsoft", function () {
            var a = L(this),
               n = 0,
               r = !1;
            ! function e(t) {
               a.classList.contains(N.next) ? W.nextMonth() : a.classList.contains(N.prev) && W.prevMonth(), N.monthChangeSpinner && (r || (n = setTimeout(e, t || 100)))
            }(500), L([N.ownerDocument.body, N.contentWindow]).addEventListener("touchend mouseup.xdsoft", function e() {
               clearTimeout(n), r = !0, L([N.ownerDocument.body, N.contentWindow]).removeEventListener("touchend mouseup.xdsoft", e)
            })
         }), o.querySelector(".xdsoft_prev,.xdsoft_next").addEventListener("touchend mousedown.xdsoft", function () {
            var o = L(this),
               i = 0,
               s = !1,
               d = 110;
            ! function e(t) {
               ...
               o.classList.contains(N.next) && n - a - N.timeHeightInTimePicker >= r ? P.css("marginTop", "-" + (r + N.timeHeightInTimePicker) + "px") : o.classList.contains(N.prev) && 0 <= r - N.timeHeightInTimePicker && P.css("marginTop", "-" + (r - N.timeHeightInTimePicker) + "px"), u.trigger("scroll_element.xdsoft_scroller", [Math.abs(parseInt(P[0].style.marginTop, 10) / (n - a))]), d = 10 < d ? 10 : d - 10, s || (i = setTimeout(e, t || d))
            }(500), L([N.ownerDocument.body, N.contentWindow]).addEventListener("touchend mouseup.xdsoft", function e() {
               clearTimeout(i), s = !0, L([N.ownerDocument.body, N.contentWindow]).removeEventListener("touchend mouseup.xdsoft", e)
            })
         }), t = 0, _.addEventListener("xchange.xdsoft", function (e) {
            clearTimeout(t), t = setTimeout(function () {
               ...
               l += "</tbody></table>", C.html(l), F.querySelector(".xdsoft_label span").eq(0).text(N.i18n[R].months[W.currentTime.getMonth()]), F.querySelector(".xdsoft_label span").eq(1).text(W.currentTime.getFullYear() + N.yearOffset), M = b = "";
               var x = 0;
               if (!1 !== N.minTime) {
         ...
         }).addEventListener("afterOpen.xdsoft", function () {
            var e, t, a, n;
            N.timepicker && (P.querySelector(".xdsoft_current").length ? e = ".xdsoft_current" : P.querySelector(".xdsoft_init_time").length && (e = ".xdsoft_init_time"), e ? (t = u[0].clientHeight, (a = P[0].offsetHeight) - t < (n = P.querySelector(e).index() * N.timeHeightInTimePicker + 1) && (n = a - t), u.trigger("scroll_element.xdsoft_scroller", [parseInt(n, 10) / (a - t)])) : u.trigger("scroll_element.xdsoft_scroller", [0]))
         }), n = 0, C.addEventListener("touchend click.xdsoft", "td", function (e) {
            e.stopPropagation(), n += 1;
            var t = L(this),
               a = W.currentTime;
            if (null == a && (W.currentTime = W.now(), a = W.currentTime), t.classList.contains("xdsoft_disabled")) return !1;
            a.setDate(1), a.setFullYear(t.data("year")), a.setMonth(t.data("month")), a.setDate(t.data("date")), _.trigger("select.xdsoft", [a]), O.val(W.str()), N.onSelectDate && L.isFunction(N.onSelectDate) && N.onSelectDate.call(_, W.currentTime, _.data("input"), e), _.data("changed", !0), _.trigger("xchange.xdsoft"), _.trigger("changedatetime.xdsoft"), (1 < n || !0 === N.closeOnDateSelect || !1 === N.closeOnDateSelect && !N.timepicker) && !N.inline && _.trigger("close.xdsoft"), setTimeout(function () {
               n = 0
            }, 200)
         }), P.addEventListener("touchstart", "div", function (e) {
            this.touchMoved = !1
         }).addEventListener("touchmove", "div", l).addEventListener("touchend click.xdsoft", "div", function (e) {
            if (!this.touchMoved) {
               e.stopPropagation();
               var t = L(this),
                  a = W.currentTime;
         ...
         }), g.addEventListener("mousewheel.xdsoft", function (e) {
            return !N.scrollMonth || (e.deltaY < 0 ? W.nextMonth() : W.prevMonth(), !1)
         }), O.addEventListener("mousewheel.xdsoft", function (e) {
            return !N.scrollInput || (!N.datepicker && N.timepicker ? (0 <= (a = P.querySelector(".xdsoft_current").length ? P.querySelector(".xdsoft_current").eq(0).index() : 0) + e.deltaY && a + e.deltaY < P.children().length && (a += e.deltaY), P.children().eq(a).length && P.children().eq(a).trigger("mousedown"), !1) : N.datepicker && !N.timepicker ? (g.trigger(e, [e.deltaY, e.deltaX, e.deltaY]), O.val && O.val(W.str()), _.trigger("changedatetime.xdsoft"), !1) : void 0)
         }), _.addEventListener("changedatetime.xdsoft", function (e) {
         ...
         }, _.addEventListener("open.xdsoft", function (e) {
            var t = !0;
            N.onShow && L.isFunction(N.onShow) && (t = N.onShow.call(_, W.currentTime, _.data("input"), e)), !1 !== t && (_.show(), r(), L(N.contentWindow).removeEventListener("resize.xdsoft", r).addEventListener("resize.xdsoft", r), N.closeOnWithoutClick && L([N.ownerDocument.body, N.contentWindow]).addEventListener("touchstart mousedown.xdsoft", function e() {
               _.trigger("close.xdsoft"), L([N.ownerDocument.body, N.contentWindow]).removeEventListener("touchstart mousedown.xdsoft", e)
            }))
         }).addEventListener("close.xdsoft", function (e) {
            var t = !0;
            F.querySelector(".xdsoft_month,.xdsoft_year").querySelector(".xdsoft_select").hide(), N.onClose && L.isFunction(N.onClose) && (t = N.onClose.call(_, W.currentTime, _.data("input"), e)), !1 === t || N.opened || N.inline || _.hide(), e.stopPropagation()
         }).addEventListener("toggle.xdsoft", function () {
            _.is(":visible") ? _.trigger("close.xdsoft") : _.trigger("open.xdsoft")
         }).data("input", O), d = 0, _.data("xdsoft_datetime", W), _.setOptions(N), W.setCurrentTime(f()), O.data("xdsoft_datetimepicker", _).addEventListener("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function () {
         ...
         }).addEventListener("keydown.xdsoft", function (e) {
            var t, a = e.which;
         ...
         }).addEventListener("blur.xdsoft", function () {
            _.trigger("close.xdsoft")
         })
      }, r = function (e) {
         var t = e.data("xdsoft_datetimepicker");
         t && (t.data("xdsoft_datetime", null), t.remove(), e.data("xdsoft_datetimepicker", null).removeEventListener(".xdsoft"), L(N.contentWindow).removeEventListener("resize.xdsoft"), L([N.contentWindow, N.ownerDocument.body]).removeEventListener("mousedown.xdsoft touchstart"), e.unmousewheel && e.unmousewheel())
      }, L(N.ownerDocument).removeEventListener("keydown.xdsoftctrl keyup.xdsoftctrl").removeEventListener("keydown.xdsoftcmd keyup.xdsoftcmd").addEventListener("keydown.xdsoftctrl", function (e) {
         e.keyCode === p && (I = !0)
      }).addEventListener("keyup.xdsoftctrl", function (e) {
         e.keyCode === p && (I = !1)
      }).addEventListener("keydown.xdsoftcmd", function (e) {
         91 === e.keyCode && !0
      }).addEventListener("keyup.xdsoftcmd", function (e) {
         91 === e.keyCode && !1
      }), this.each(function () {
         ...
         "string" !== L.type(H) && (!N.lazyInit || N.open || N.inline ? n(L(this)) : (t = L(this)).addEventListener("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", function e() {
            t.is(":disabled") || t.data("xdsoft_datetimepicker") || (clearTimeout(i), i = setTimeout(function () {
               t.data("xdsoft_datetimepicker") || n(t), t.removeEventListener("open.xdsoft focusin.xdsoft mousedown.xdsoft touchstart", e).trigger("open.xdsoft")
            }, 100))
         }))
      }), o
